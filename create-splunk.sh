...
ETH_LINUX="lo"		#default interface to use with Linux server
...
START_ALIAS_LINUX="192.168.17.100";  	END_ALIAS_LINUX="192.168.17.254"
...
DSCLI_FILE="deploymentclient.conf"
